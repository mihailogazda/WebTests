 ...
 * Changes to support jQueryUI 1.8 and jQuery 1.4 provided by and copyright (c) 2011 Cailie Crane for Pulse Energy
 *
...
$.widget("ui.multidraggable", $.extend({}, $.ui.draggable.prototype, {
	...
	_mouseCapture: function(event) {
		...
		if (event.ctrlKey) {
			...
			this.element.toggleClass('ui-selected');
		}
	...
	mouseStart: function(event, draggedOptions) {
		...
		if (this.element.hasClass('ui-selected')) {
		...
		if (this.element.hasClass('ui-selected') && o.isMain) {
	...
	_mouseStart: function(event) {
		...
		if (this.element.hasClass('ui-selected')) {
			...
			$(".ui-selected").multidraggable("mouseStart", event, o);
			return true;
		} else {
	...
	_mouseDrag: function(event, noPropagation) {
		if (this.element.hasClass('ui-selected')) {
			$(".ui-selected").multidraggable("mouseDrag", event, noPropagation);
			return false;
		} else {
	...
	_mouseStop: function(event) {
		if (this.element.hasClass('ui-selected')) {
			$(".ui-selected").multidraggable("mouseStop", event);
			return false;
		} else {
